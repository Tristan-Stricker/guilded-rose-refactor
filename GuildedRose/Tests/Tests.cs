namespace Tests
{
    ...
    {
        [Theory]
        [InlineData(16, 14, "Normal", 0)]  // Once the sell by date has passed, Quality degrades twice as fast
        [InlineData(-1, 0, "Normal", 0)]  // The Quality of an item is never negative
        [InlineData(2, 3, "Aged Brie", 2)]  // "Aged Brie" actually increases in Quality the older it gets
        [InlineData(60, 50, "Aged Brie", 2)]  // The Quality of an item is never more than 50
